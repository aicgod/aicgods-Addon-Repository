...
ADDON=xbmcaddon.Addon(id='plugin.video.aicgodsbuildwizard)
dialog = xbmcgui.Dialog()    
VERSION = "1.0.1"
PATH = "aicgodsbuildwizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://copy.com/fIZho8XwjQhsxAeP/wizard.txt?download=1').replace('\n','').replace('\r','')
